...
export const requireSecret = (req, res, next) => {
...
export const requireAuth = ({authdbClient = null, secret = '', paramName = 'token'}: {authdbClient:any, secret: string, paramName?: string} = {authdbClient: null, secret: '', paramName: 'token'}) => (req, res, next) => {
